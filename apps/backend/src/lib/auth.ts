...
export const auth = betterAuth({
  ...
  basePath: "/api/auth", // Tell better-auth where routes are mounted
  trustedOrigins:
    env.NODE_ENV === "development"
      ? ["*"] // Allow all origins in development (for Postman)
  ...
  advanced: {
    // Disable CSRF check in development for Postman testing
