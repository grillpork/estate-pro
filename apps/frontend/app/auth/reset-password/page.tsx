                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full bg-white/5 border ${errors.password
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full bg-white/5 border ${errors.confirmPassword
                                    ? "border-red-500/50 focus:border-red-500"
                                    : "border-white/10 focus:border-amber-500/60"
                                } text-white placeholder-white/20 rounded-xl pl-10 pr-12 py-3 text-sm outline-none transition-all duration-200 focus:bg-white/8 focus:ring-2 ${errors.confirmPassword ? "focus:ring-red-500/20" : "focus:ring-amber-500/15"
                                }`}
                        />
                        <button
                            type="button"
