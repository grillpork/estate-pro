                ...
                {options.map(option => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2.5 text-sm transition-colors flex items-center gap-3 ${isActive
                          ? "text-white bg-white/5"
                          : "text-white/60 hover:text-white hover:bg-white/5"
                        }`}
                    >
                      <span
                        className={`w-1 h-5 rounded-full transition-colors ${isActive ? "bg-amber-500" : "bg-transparent"
                          }`}
                      />
                      {option.label}
                    </button>
            ...
            <section className="bg-[#111118] p-6 rounded-2xl border border-white/5 flex flex-col">
              ...
              <div className="bg-white/5 p-1.5 rounded-full flex gap-1 h-full items-center">
                <button
                  ...
                  className={`flex-1 py-3 px-6 rounded-full text-sm font-semibold transition-all duration-300 ${formMode === "PROPERTY"
                ...
                <button
                  ...
                  className={`flex-1 py-3 px-6 rounded-full text-sm font-semibold transition-all duration-300 ${formMode === "BRAND"
                      ? "bg-amber-500/10 text-amber-400 shadow-sm ring-1 ring-amber-500/20"
                      : "text-white/50 hover:text-white/70 hover:bg-white/5"
                    }`}
                >
                ...
                {LISTING_TYPES.map(type => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-full text-sm font-semibold transition-all duration-300 ${isActive
                          ? "bg-amber-500/10 text-amber-400 shadow-sm ring-1 ring-amber-500/20"
                          : "text-white/50 hover:text-white/70 hover:bg-white/5"
                        }`}
                    >
                  ...
                  {AMENITIES.map(amenity => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-3 p-3.5 rounded-xl border transition-all text-[13px] font-medium ${active
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
        <div className="bg-[#111118]/90 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.3)] rounded-full p-2 flex items-center gap-2 border border-white/10">
          ...
          <button
            ...
            disabled={formMode === "BRAND"}
            className={`px-6 py-2.5 rounded-full flex items-center gap-2 font-bold text-[13px] transition-colors ${formMode === "BRAND" ? "text-white/20 cursor-not-allowed" : "text-blue-400 hover:bg-blue-500/10"
              }`}
          >
